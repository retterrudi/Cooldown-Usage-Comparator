...
public enum AbilityGameId
{
    ...
    // Isle of Dorn Gems
    StormSewerCitrine       = 462958, 
    OldSaltsBardicCitrine   = 462959, 
    MarinerHallowedCitrine  = 462960, 
    StormSewerCitrineDamage = 468422, 
    
    // Rookery
    ChaoticCorruptionSpell     =  424739, 
    ChaoticVulnerabilityDebuff =  424797, 
    LingeringVoidSpell         =  424966, 
    CrushRealitySpell          =  425113, 
    DarkGravitySpell           =  426160, 
    ...
    FrostboltSpell              =   59638,
    CauterizeSpell              =   86949, 
    CauterizeDebuff             =   87023, 
    CauterizedDebuff2           =   87024,
    BlazingSpeedBuff            =  108843,
    ...
    SpiritLinkTotemBuff     = 325174, 
    EarthlivingWeaponBuff   = 382024, 
    ChainHealSpell2         = 458357, 
    SpoutingSpiritsSpell    = 462384, 
